...
class CustomerAlsoBoughtProducts{
    ...
    try {
      if (statusCode == 200) {
        ...
        if (body.containsKey("errors")) {
          ...
          List list = body["ProductAlsoPurchasedList"];
          List<ProductListModel> productModelList = list.map((c) => new ProductListModel.fromMapForRelatedProduct(c)).toList();
          return {
            'errorCode': "0",
