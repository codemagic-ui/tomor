...
class GetBrandProductListBySubCategory {
    ...
    try {
      if (statusCode == 200) {
        ...
        if (body.containsKey("errors")) {
          ...
          List list = body["ProductList"];
          List<ProductListModel> productModelList = list.map((c) => new ProductListModel.fromMapForBrandProductList(c)).toList();
          return {
            'errorCode': "0",
