...
class DownloadAbleProductListParser {
  static Future callApi(String url) async {
    ...
    try {
      if (statusCode == 200) {
        ...
        Map downloadAbleProduct = body["DownloadableProduct"];

        RewardPointModel mRewardPointModel = RewardPointModel.fromMapForDownloadAbleProductList(downloadAbleProduct);
