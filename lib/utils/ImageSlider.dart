...
class ImageSlider extends StatefulWidget {
  //All the images on this ImageSlider.
  final List image;
  ...
  @override
  State createState() => new ImageSliderState();
}

class ImageSliderState extends State<ImageSlider> with AfterLayoutMixin {
  ...
  Widget build(BuildContext context) {
    final List<Widget> listImages = widget.image
        .map((netImage) => new InkWell(
...
//        print("condition ${widget.image.length} , ${_controller.page.round()} = ${_controller.page == widget.image.length - 1}");
        if (_controller.page != null) {
          if (_controller.page.round() == widget.image.length - 1) {
            _controller.animateToPage(
              0,
              duration: widget.animationDuration,
              curve: widget.animationCurve,
